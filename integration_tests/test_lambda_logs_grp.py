...
def create_log_group(logs_client, log_group_name):
    ...
    print(f"Created log group named {log_group_name}")
...
if __name__ == "__main__":
    ...
    function_name = create_lambda_function(lambda_client, prefix="grp")

    print(f"Lambda function '{function_name}' created successfully.")

    log_group_name = get_log_group_name(lambda_client, function_name)
    create_log_group(logs_client, log_group_name)
