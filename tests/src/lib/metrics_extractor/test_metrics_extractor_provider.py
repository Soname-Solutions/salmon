...
def test_glue_jobs_provider(boto3_client_creator):
    ...
    assert not hasattr(extractor, 'send_alerts'), "Extractor should not have a 'send_alerts' method"
...
def test_glue_workflows_provider(boto3_client_creator):
    ...
    assert hasattr(extractor, 'send_alerts'), "Extractor should have a 'send_alerts' method"
