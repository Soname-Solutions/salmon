...
def lambda_handler(event, context):
    ...
    last_update_times = retrieve_last_update_time_for_all_resources(query_runner, timestream_metrics_db_name, logger)
    ...
    for monitoring_group in monitoring_groups:
        ...
        lambda_client.invoke(
            ...
            Payload=json.dumps({"monitoring_group" : monitoring_group, "last_update_times" : last_update_times})
        )
